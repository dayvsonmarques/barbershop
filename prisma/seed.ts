...
async function main() {
  ...
  const productData = [
    ...
    { categoryId: pomadeCategory.id,   name: "Produto Teste",                     slug: "produto-teste",                   description: "Produto para testes de checkout.",           price: 0.01,  discountPrice: null, stock: 99, images: [{ url: "https://images.unsplash.com/photo-1775127741393-2b571811bb01?auto=format&fit=crop&w=800&h=800", title: "Teste", description: "", position: 0, isPrimary: true }] },
  ];
