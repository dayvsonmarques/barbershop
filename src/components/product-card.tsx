...
export function ProductCard({ id, name, slug, price, discountPrice, primaryImageUrl }: Props) {
  ...
  function handleAddToCart(e: React.MouseEvent) {
    e.preventDefault();
    addItem({ productId: id, name, price: displayPrice, imageUrl: primaryImageUrl ?? "" });
  }
