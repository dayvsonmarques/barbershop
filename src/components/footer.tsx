        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-2 text-gray-300 transition-colors hover:text-yellow-500"
            ...
            {whatsappHref ? (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-6 inline-flex items-center gap-3 px-2 text-gray-300 transition-colors hover:text-yellow-500"
                aria-label="WhatsApp"
              >
                <svg
                  className="w-14 h-14"
