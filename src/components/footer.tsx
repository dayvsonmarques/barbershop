    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-white text-lg font-bold mb-4">ED Barbearia</h3>
            <p className="text-sm mb-4">
              Estilo, tradição e qualidade em um só lugar. Atendemos você com
              profissionalismo e dedicação há mais de 10 anos.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-center">
                <span className="mr-2">📧</span>
                <span>contato@edbarbearia.com</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">🕐</span>
                <span>Seg-Sex: 9h às 20h<br />Sáb: 9h às 18h</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm">
          <p>
            &copy; {currentYear} ED Barbearia. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
