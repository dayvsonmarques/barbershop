...
export function Navbar() {
  ...
  return (
    ...
    >
      ...
      {open && (
        <div className="fixed inset-0 z-[60] bg-background-primary flex flex-col items-center justify-center md:hidden">
          ...
          <div className="flex flex-col items-center gap-8 mb-10">
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="font-heading text-3xl text-text-primary hover:text-gold transition-colors duration-200"
                onClick={() => setOpen(false)}
              >
                {link.label}
              </a>
